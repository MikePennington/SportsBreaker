 ...
 */
package com.breaker.recaptcha;

import java.net.URLEncoder;
import java.util.Enumeration;
import java.util.Properties;

import com.breaker.recaptcha.http.HttpLoader;
import com.breaker.recaptcha.http.SimpleHttpLoader;
...
public class ReCaptchaImpl implements ReCaptcha {
    ...
    public ReCaptchaResponse checkAnswer(String remoteAddr, String challenge, String response) {
        ...
        String postParameters = "privatekey=" + URLEncoder.encode(privateKey) + "&remoteip="
                + URLEncoder.encode(remoteAddr) + "&challenge=" + URLEncoder.encode(challenge)
    ...
    public String createRecaptchaHtml(String errorMessage, Properties options) {
        ...
        message += "<script type=\"text/javascript\" src=\"" + recaptchaServer + "/challenge?k="
